...
/**
 * PDF generation functions removed to reduce bundle size.
 * Dependencies html2canvas and jspdf have been uninstalled.
 * If you need PDF export in the future, install:
 * npm install html2canvas jspdf @types/jspdf
 */
